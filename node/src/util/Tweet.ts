...
export default class Tweet {
	...
	async uploadMedia(media: Buffer): Promise<string> {
		...
		const mediaId = await this.#twitterApiv1.uploadMedia(media, { mimeType: fileTypeResult.mime }); // https://developer.twitter.com/en/docs/twitter-api/v1/media/upload-media/api-reference/post-media-upload
		return mediaId;
	}
